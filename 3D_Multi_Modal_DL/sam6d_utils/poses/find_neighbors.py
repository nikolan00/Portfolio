...
import os
from sam6d_utils.poses.pose_utils import (
...
if __name__ == "__main__":
    for template_level in range(2):
        ...
        save_path = os.path.join(root_repo, f"sam6d_utils/poses/predefined_poses/idx_all_level{template_level}_in_level2.npy")
    ...
    save_path = os.path.join(root_repo, "sam6d_utils/poses/predefined_poses/idx_all_level2_in_level2.npy")
